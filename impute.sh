...
## Call IMPUTE2
$impute2 \
    -m $gen_map/genetic_map_chr"$chr"_combined_b37.txt \ ## genetic map
    -h $kgp/1000GP_Phase3_chr$chr.hap.gz \ ## 1KG Phase 3 data
    -l $kgp/1000GP_Phase3_chr$chr.legend.gz \ ## 1KG Phase 3 data
